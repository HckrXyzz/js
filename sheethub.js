...
app.classList = "bg-gray-900 font-sans antialiased dark transition-colors duration-200 text-gray-200";
const header = document.createElement("header");
header.classList = "fixed top-0 left-0 right-0 h-16 z-50 bg-slate-950/80 backdrop-blur";
const aside = document.createElement("aside")
aside.id = "sidebar";
const main = document.createElement("main")
const footer = document.createElement("footer")
app.append(header,aside,main,footer)
